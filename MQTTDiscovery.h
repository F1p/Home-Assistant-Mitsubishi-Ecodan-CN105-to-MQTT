...
const char MQTT_CLIMATE_STATE_TOPIC[][432] PROGMEM = {
  "{{ 'heat' if (value_json.SystemOperationMode=='Hot Water' or value_json.SystemOperationMode=='Legionella') else 'off' }}",
  "{{ 'heat' if (value_json.SystemOperationMode=='Heating' and states('sensor.zone_2_temperature')=='0') else 'heat' if (value_json.SystemOperationMode == 'Heating' and states('sensor.zone_1_working') == '1') else 'cool' if (value_json.SystemOperationMode == 'Cooling' and states('sensor.zone_2_temperature') == '0') else 'cool' if (value_json.SystemOperationMode == 'Cooling' and states('sensor.zone_1_working') == '1') else 'off' }}",
  "{{ 'heat' if (value_json.SystemOperationMode=='Heating' and states('sensor.zone_2_temperature')=='0') else 'heat' if (value_json.SystemOperationMode == 'Heating' and states('sensor.zone_2_working') == '1') else 'cool' if (value_json.SystemOperationMode == 'Cooling' and states('sensor.zone_2_temperature') == '0') else 'cool' if (value_json.SystemOperationMode == 'Cooling' and states('sensor.zone_2_working') == '1') else 'off' }}"
};

const char MQTT_SELECT_VALUE_TOPIC[][432] PROGMEM = {
