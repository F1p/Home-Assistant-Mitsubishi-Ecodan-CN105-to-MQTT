...
3. Select Install and Upload the .merged.bin: <img width="356" height="186" alt="image" src="https://github.com/user-attachments/assets/2c960fd4-8d67-4ce4-a9f0-dc92842087dc" />

4. The Pins on the M5Stack are: 1 = Tx, 2 = Rx (Onboard Grove Port)
